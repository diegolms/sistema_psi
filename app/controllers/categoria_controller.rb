class CategoriaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categorium.save
        format.html { redirect_to categoria_url, notice: 'Categoria cadastrada com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @categorium.update(categorium_params)
        format.html { redirect_to categoria_url, notice: 'Categoria editada com sucesso.' }
